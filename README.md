# Java Spring Security Demo with JDBC Driver

## To start
- Setup DB using script from below (current password is fun123, but feel free to change it)
- Run project on server (i.e. tomcat)
